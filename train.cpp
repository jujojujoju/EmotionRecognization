...
void svm(int num_of_label, Mat train_features, Mat train_labels, vector<string> train_paths, Mat test_features, Mat test_labels, vector<string> test_paths, string output_folder );
void knn(int num_of_label, Mat train_features, Mat train_labels, vector<string> train_paths, Mat test_features, Mat test_labels, vector<string> test_paths, int K, string output_folder);
void bayes(int num_of_label, Mat train_features, Mat train_labels, vector<string> train_paths, Mat test_features, Mat test_labels, vector<string> test_paths, string output_folder);
...
int main(int argc, char* argv[]) {
    ...
    if( algorithm_name.compare( "mlp" ) == 0 ){
        ...
        svm(num_of_label, train_features, train_labels, train_paths, test_features, test_labels, test_paths,output_folder);
    } else if (algorithm_name.compare( "knn" ) == 0){
        knn(num_of_label, train_features, train_labels, train_paths, test_features, test_labels, test_paths, 2, output_folder);
    } else if (algorithm_name.compare( "bayes" ) == 0){
        bayes(num_of_label, train_features, train_labels, train_paths, test_features, test_labels, test_paths, output_folder);
    }
...
void mlp(int num_of_label, Mat train_features, Mat train_labels, vector<string> train_paths, Mat test_features, Mat test_labels, vector<string> test_paths ){
    ...
    for(int i = 0 ; i < test_labels.rows; i ++){
        labels_test.at<unsigned>(i, 0) = (unsigned int) test_labels.at<int>(i, 0);
    }
...
void svm(int num_of_label, Mat train_features, Mat train_labels, vector<string> train_paths, Mat test_features, Mat test_labels, vector<string> test_paths, string output_folder ){
    ...
    cout<<"num_of_label : "<<num_of_label<<endl;
    cout<<"train_labels : "<<train_labels.rows<<endl;
    cout<<"test_labels : "<<test_labels.rows<<endl;
    ...
    for(int i = 0 ; i < train_labels.rows; i ++){
//        labels.at<unsigned>(i, 0) = (unsigned int) train_labels.at<int>(i, 0);
    ...
    string svmDir = "/Users/joju/OpenCVBlueprints/chapter_3/classifier/";
    string svmFile = "filterdimagesvmClassifier.xml";
...
//    normalize(train_features, train_features, 0, 1, NORM_MINMAX, CV_32F);
...
void bayes(int num_of_label, Mat train_features, Mat train_labels, vector<string> train_paths, Mat test_features, Mat test_labels, vector<string> test_paths, string output_folder){
    ...
    string bayesDir = "/Users/joju/OpenCVBlueprints/chapter_3/classifier/";
...
//        Ptr<ml::NormalBayesClassifier> bayes1 = ml::NormalBayesClassifier::load(bayesDir+bayesFile);
    ...
    for(int i = 0; i < test_features.rows; i++) {
        ...
        predicted.at<float>(i, output.at<unsigned>(0, 0)) = 1.0f;
    }
